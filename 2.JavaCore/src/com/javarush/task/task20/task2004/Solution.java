...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File myTmpFile = File.createTempFile("myTMPfile", null);
            OutputStream outputStream = new FileOutputStream(myTmpFile);
            InputStream inputStream = new FileInputStream(myTmpFile);
