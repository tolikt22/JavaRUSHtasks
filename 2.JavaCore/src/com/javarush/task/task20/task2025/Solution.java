    ...
    public static long[] getNumbers(long N) {
        ...
        for (long i = 1; i < N; i++) {
            ...
            for (int j = 0; j < lenCount; j++) {
                if (powLst[digits[j]][lenCount] == 0) { //Если в массиве степеней еще нет значения
                    long a1 = digits[j];
                    ...
                    powLst[digits[j]][lenCount] = a1;//Добавляем в массив степеней новое значение
                }
                summa1 += powLst[digits[j]][lenCount];
            }
            ...
            for (int j = 0; j < lenCount; j++) {
                ...
                summa2 += powLst[digits[j]][lenCount];
            }
